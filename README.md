...
This is a tool for restoring corrupted Minecraft block region files (`.mca` files in `region/`) when you have a world that started looking like hell of a mess of chunks after a crash. It helps when your world starts to look like this after your minacraft client or a server has crashed:
